...
This document describes how to contribute to Hub.
...
To contribute to Hub on GitHub, you can:
...
To report a bug, [open a new issue](https://github.com/iotaledger/hub/issues/new), and be sure to include as many details as possible, using the template.
...
**Ensure the feature has not already been suggested** by searching on GitHub under [**Issues**](https://github.com/iotaledger/hub/issues).

### Suggesting a new feature

To suggest a new feature, talk to the IOTA community and IOTA Foundation members in the #hub-discussion channel on [Discord](https://discord.iota.org/).

If the Hub team approves your feature, the team will create an issue for it.
</details>
...
Make sure to discuss the feature in the #hub-discussion channel on [Discord](https://discord.iota.org/).
...
- If the feature has a public facing API, make sure to document it
...
The Hub documentation is hosted on https://docs.iota.org, which is built from content in the [documentation](https://github.com/iotaledger/documentation/tree/develop/wallets/0.1/hub) repository.
